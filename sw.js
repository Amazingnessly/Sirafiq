const CACHE_NAME = 'sirafiq-shell-v120';
const APP_FILES = [
  './', './index.html', './styles.css?v=120', './app.js?v=120', './db.js?v=120', './lot1.js?v=120',
  './writing.js?v=120', './pronunciation.js?v=120', './learning.js?v=120', './mindmap-engine.js?v=120', './manifest.webmanifest',
