const CACHE_NAME = 'sirafiq-shell-v71';
const APP_FILES = [
  './', './index.html', './styles.css?v=71', './app.js?v=71', './db.js?v=71', './lot1.js?v=71',
  './writing.js?v=71', './pronunciation.js?v=71', './learning.js?v=71', './manifest.webmanifest',
