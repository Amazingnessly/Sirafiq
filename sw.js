const CACHE_NAME = 'sirafiq-shell-v7';
const APP_FILES = [
  './', './index.html', './styles.css?v=7', './app.js?v=7', './db.js?v=7', './lot1.js?v=7',
  './writing.js?v=7', './pronunciation.js?v=7', './learning.js?v=7', './manifest.webmanifest',
